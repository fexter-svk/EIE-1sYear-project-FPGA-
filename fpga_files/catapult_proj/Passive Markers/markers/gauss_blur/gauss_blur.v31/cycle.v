...
//  Generated date: Mon May 09 09:13:14 2016
// ----------------------------------------------------------------------
...
module gauss_blur_core (
  ...
  begin : core
    ...
    reg unequal_tmp;
    reg [3:0] acc_12_0_sva_dfm;
    reg [3:0] acc_12_1_sva_dfm;
    reg equal_1_cse_sva;
    reg land_sva_1;
    reg land_lpi_1_dfm;
    ...
    reg volume_current_slc_conc_imod_sg1_itm_1;
    reg [4:0] volume_current_slc_conc_imod_sg1_2_itm_1;
    reg volume_current_slc_conc_imod_sg1_6_itm_1;
    reg volume_current_slc_conc_imod_sg1_7_itm_1;
    reg volume_current_slc_conc_imod_sg1_1_itm_1;
    ...
    reg [1:0] volume_current_slc_acc_idiv_9_itm_1;
          ...
          forever begin : main
            ...
            if ( main_stage_0_2 ) begin
              ...
              land_13_lpi_1_dfm = aif_47_land_sva_1 & (~ (deltay_square_blue_acc_psp_sva[10]))
                  & land_14_lpi_1_dfm_1;
              conc_imod_1_sg1_sva = (conv_s2s_5_6({volume_current_slc_conc_imod_sg1_5_itm_1
                  , 2'b0 , ({{1{volume_current_slc_conc_imod_sg1_itm_1}}, volume_current_slc_conc_imod_sg1_itm_1})})
                  + conv_u2s_5_6(volume_current_slc_conc_imod_sg1_2_itm_1)) + ({volume_current_slc_conc_imod_sg1_6_itm_1
                  , 1'b0 , ({{1{volume_current_slc_conc_imod_sg1_7_itm_1}}, volume_current_slc_conc_imod_sg1_7_itm_1})
                  , 1'b0 , volume_current_slc_conc_imod_sg1_1_itm_1});
              volume_current_sva = (readslicef_5_4_1((conv_u2u_4_5({slc_acc_idiv_5_itm_1
                  , 1'b0 , slc_acc_idiv_2_itm_1 , 1'b1}) + conv_u2u_4_5({volume_current_slc_acc_idiv_10_itm_1
                  , volume_current_slc_acc_idiv_11_itm_1 , (volume_current_slc_acc_idiv_7_itm_1
                  ...
                  , 1'b1}) + conv_u2s_3_5({volume_current_slc_acc_idiv_9_itm_1 ,
                  (~((conc_imod_1_sg1_sva[5]) & (~ volume_current_slc_acc_idiv_6_itm_1)))}))));
              acc_10_cse_sva = readslicef_6_5_1((({1'b1 , volume_current_sva , 1'b1})
                  + conv_u2s_5_6({(~ volume_previous_sva) , 1'b1})));
              slc_8_svs = readslicef_5_1_4((conv_s2u_4_5(acc_10_cse_sva[4:1]) + 5'b1));
              if ( slc_8_svs ) begin
              end
              else begin
                land_15_sva_1 = ~ (readslicef_6_1_5((conv_s2s_5_6(~ acc_10_cse_sva)
                    + 6'b11)));
              end
              volume_previous_sva_dfm = MUX_v_4_2_2({volume_previous_sva , volume_current_sva},
                  land_15_sva_1 & (~ slc_8_svs));
              volume_rsc_mgc_out_stdreg_d <= volume_previous_sva_dfm & ({{3{or_3_itm_1}},
                  or_3_itm_1});
              if ( lor_3_lpi_1_dfm_st_1 ) begin
              end
              else begin
                lor_2_sva_1 = (vga_xy[18]) & (vga_xy[17]) & (vga_xy[16]) & (vga_xy[15])
                    & (vga_xy[14]) & (vga_xy[12]) & (~((vga_xy[19]) | (vga_xy[13])
                    | (vga_xy[11]) | (vga_xy[10])));
              end
            ...
            unequal_tmp = (if_3_acc_svs[3]) | (if_3_acc_svs[2]) | (if_3_acc_svs[1])
                | (if_3_acc_svs[0]);
            acc_12_0_sva_dfm = acc_12_0_sva & ({{3{unequal_tmp}}, unequal_tmp});
            acc_12_1_sva_dfm = acc_12_1_sva & ({{3{unequal_tmp}}, unequal_tmp});
            ...
            if ( land_2_sva_1 & land_3_lpi_1_dfm ) begin
              acc_12_0_sva_dfm_1 = acc_12_0_sva_dfm + 4'b1;
            end
            else begin
              acc_12_0_sva_dfm_1 = acc_12_0_sva_dfm;
            end
            ...
            if ( aif_17_land_sva_1 & (~ aif_17_slc_svs) & land_5_lpi_1_dfm ) begin
              acc_12_1_sva_dfm_1 = acc_12_1_sva_dfm + 4'b1;
            end
            else begin
              acc_12_1_sva_dfm_1 = acc_12_1_sva_dfm;
            end
            slc_2_svs = readslicef_5_1_4((({1'b1 , (~ acc_12_0_sva_dfm_1)}) + 5'b111));
            if ( slc_2_svs ) begin
            ...
            red_xy_1_sva_dfm_2 = MUX_v_10_2_2({red_xy_1_sva_dfm , red_xy_1_sva_2},
                and_7_cse);
            slc_3_svs = readslicef_5_1_4((({1'b1 , (~ acc_12_1_sva_dfm_1)}) + 5'b111));
            if ( slc_3_svs ) begin
            ...
            acc_idiv_sva = conv_u2s_10_11(~ red_xy_1_sva_dfm_2) + 11'b10111100001;
            conc_imod_sg1_sva = (({5'b10010 , (acc_idiv_sva[9:8])}) + conv_u2s_6_7(conv_u2u_5_6({(acc_idiv_sva[7])
                , 2'b0 , (signext_2_1(acc_idiv_sva[7]))}) + conv_u2u_5_6(acc_idiv_sva[5:1])))
                + conv_u2u_6_7((readslicef_7_6_1((conv_u2u_6_7({(~ (acc_idiv_sva[9:8]))
                , 4'b1}) + conv_u2u_6_7({(~ (acc_idiv_sva[10])) , 3'b111 , (~ (acc_idiv_sva[10]))
                , 1'b1})))) + conv_s2u_5_6({(acc_idiv_sva[6]) , 2'b0 , (signext_2_1(acc_idiv_sva[6]))}));
            if ( equal_1_cse_sva ) begin
            end
            else begin
              lor_5_sva_1 = (vga_xy[17]) & (vga_xy[13]) & (vga_xy[12]) & (~((vga_xy[19])
                  | (vga_xy[18]) | (vga_xy[16]) | (vga_xy[15]) | (vga_xy[14]) | (vga_xy[11])
                  | (vga_xy[10])));
            end
            ...
            if ( lor_5_lpi_1_dfm ) begin
              ...
              lor_4_sva_1 = (vga_xy[18]) & (vga_xy[12]) & (~((vga_xy[19]) | (vga_xy[17])
                  | (vga_xy[16]) | (vga_xy[15]) | (vga_xy[14]) | (vga_xy[13]) | (vga_xy[11])
                  | (vga_xy[10])));
            end
            ...
            if ( lor_4_lpi_1_dfm ) begin
              ...
              lor_3_sva_1 = (vga_xy[18]) & (vga_xy[16]) & (vga_xy[15]) & (vga_xy[14])
                  & (vga_xy[13]) & (vga_xy[12]) & (~((vga_xy[19]) | (vga_xy[17])
                  | (vga_xy[11]) | (vga_xy[10])));
            end
            ...
            volume_current_slc_conc_imod_sg1_itm_1 = conc_imod_sg1_sva[5];
            ...
            volume_current_slc_conc_imod_sg1_7_itm_1 = conc_imod_sg1_sva[6];
            volume_current_slc_conc_imod_sg1_1_itm_1 = conc_imod_sg1_sva[6];
            slc_acc_idiv_5_itm_1 = acc_idiv_sva[10];
            slc_acc_idiv_2_itm_1 = acc_idiv_sva[10];
            volume_current_slc_acc_idiv_10_itm_1 = acc_idiv_sva[9:8];
            volume_current_slc_acc_idiv_11_itm_1 = acc_idiv_sva[6];
            volume_current_slc_acc_idiv_7_itm_1 = acc_idiv_sva[10];
            ...
            volume_current_slc_acc_idiv_9_itm_1 = acc_idiv_sva[9:8];
            volume_current_slc_acc_idiv_6_itm_1 = acc_idiv_sva[10];
            or_3_itm_1 = (red_xy_1_sva_dfm_2[9]) | (red_xy_1_sva_dfm_2[8]) | (red_xy_1_sva_dfm_2[7])
                | (red_xy_1_sva_dfm_2[6]) | (red_xy_1_sva_dfm_2[5]) | (red_xy_1_sva_dfm_2[4])
                | (red_xy_1_sva_dfm_2[3]) | (red_xy_1_sva_dfm_2[2]) | (red_xy_1_sva_dfm_2[1])
                | (red_xy_1_sva_dfm_2[0]);
    ...
    volume_current_slc_acc_idiv_9_itm_1 = 2'b0;
    ...
    volume_current_slc_conc_imod_sg1_1_itm_1 = 1'b0;
    volume_current_slc_conc_imod_sg1_7_itm_1 = 1'b0;
    volume_current_slc_conc_imod_sg1_6_itm_1 = 1'b0;
    volume_current_slc_conc_imod_sg1_2_itm_1 = 5'b0;
    volume_current_slc_conc_imod_sg1_itm_1 = 1'b0;
    ...
    acc_12_1_sva_dfm = 4'b0;
    acc_12_0_sva_dfm = 4'b0;
    unequal_tmp = 1'b0;
    if_3_acc_svs = 4'b0;
