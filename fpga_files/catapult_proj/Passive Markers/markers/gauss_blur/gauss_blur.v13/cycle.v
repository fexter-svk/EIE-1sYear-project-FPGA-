...
//  Generated date: Sat May 07 15:52:09 2016
// ----------------------------------------------------------------------
        ...
        begin : mainExit
          forever begin : main
            ...
            if ( main_stage_0_2 ) begin
              ...
              volume_rsc_mgc_out_stdreg_d <= conv_s2u_3_4(readslicef_4_3_1((conv_u2s_3_4({(readslicef_3_2_1((conv_u2u_2_3({(volume_current_acc_psp_sva[3])
              ...
              if ( lor_4_lpi_1_dfm_st_1 ) begin
              end
              else begin
                lor_3_sva_1 = (vga_xy[18]) & (vga_xy[17]) & (vga_xy[16]) & (vga_xy[15])
                    & (~((vga_xy[19]) | (vga_xy[14]) | (vga_xy[13]) | (vga_xy[12])
                    | (vga_xy[11]) | (vga_xy[10])));
              end
              lor_3_lpi_1_dfm = lor_3_sva_1 | lor_4_lpi_1_dfm_1;
              vout_rsc_mgc_out_stdreg_d <= {(~((~(MAC1_acc_psp_sg1_sva_1 | ({{9{land_11_lpi_1_dfm}},
                  ...
                  | ({{9{lor_3_lpi_1_dfm}}, lor_3_lpi_1_dfm}))) , (MAC1_acc_39_psp_sg1_sva_1
                  ...
                  land_13_lpi_1_dfm}))) | ({{9{lor_3_lpi_1_dfm}}, lor_3_lpi_1_dfm})))};
              regs_regs_0_sva = vin;
            end
            lor_4_sva_1 = 1'b0;
            lor_5_sva_1 = 1'b0;
            ...
            if ( equal_1_cse_sva ) begin
              ...
              lor_6_sva_1 = (vga_xy[16]) & (vga_xy[15]) & (vga_xy[14]) & (vga_xy[13])
                  & (~((vga_xy[19]) | (vga_xy[18]) | (vga_xy[17]) | (vga_xy[12])
                  | (vga_xy[11]) | (vga_xy[10])));
            end
            lor_6_lpi_1_dfm = lor_6_sva_1 | equal_1_cse_sva;
            if ( lor_6_lpi_1_dfm ) begin
            end
            else begin
              lor_5_sva_1 = (vga_xy[17]) & (vga_xy[16]) & (vga_xy[15]) & (vga_xy[14])
                  & (~((vga_xy[19]) | (vga_xy[18]) | (vga_xy[13]) | (vga_xy[12])
                  | (vga_xy[11]) | (vga_xy[10])));
            end
            lor_5_lpi_1_dfm = lor_5_sva_1 | lor_6_lpi_1_dfm;
            if ( lor_5_lpi_1_dfm ) begin
            end
            else begin
              lor_4_sva_1 = (vga_xy[18]) & (vga_xy[16]) & (vga_xy[15]) & (vga_xy[13])
            ...
            lor_4_lpi_1_dfm_1 = lor_4_lpi_1_dfm;
            ...
            lor_4_lpi_1_dfm_st_1 = lor_4_lpi_1_dfm;
            main_stage_0_2 = 1'b1;
          end
        end
      end
