...
//  Generated date: Sat May 07 17:24:47 2016
// ----------------------------------------------------------------------
        ...
        begin : mainExit
          forever begin : main
            ...
            if ( main_stage_0_2 ) begin
              ...
              slc_8_svs = readslicef_5_1_4((conv_s2u_4_5(acc_12_cse_sva[4:1]) + 5'b1));
              if ( slc_8_svs ) begin
              end
              else begin
                land_15_sva_1 = ~ (readslicef_6_1_5((conv_s2s_5_6(~ acc_12_cse_sva)
                    + 6'b11)));
              end
            ...
            slc_2_svs = readslicef_5_1_4((({1'b1 , (~ acc_14_0_sva_dfm_1)}) + 5'b111));
            if ( slc_2_svs ) begin
            ...
            red_xy_1_sva_dfm_2 = MUX_v_10_2_2({red_xy_1_sva_dfm , red_xy_1_sva_2},
                and_7_cse);
            slc_3_svs = readslicef_5_1_4((({1'b1 , (~ acc_14_1_sva_dfm_1)}) + 5'b111));
            if ( slc_3_svs ) begin
