...
//  
project new
solution file add {../sobel_filter_sourcev2/blur_sob.h} -type CHEADER
solution file add {../sobel_filter_sourcev2/shift_class_sob.h} -type CHEADER
solution file add {../sobel_filter_sourcev2/blur_sob.c} -type C++
...
directive set -DESIGN_HIERARCHY sobel_filter
go compile
...
directive set /sobel_filter/vout -STREAM 30
directive set /sobel_filter/vin -STREAM 90
directive set /sobel_filter/core/MAC2 -UNROLL yes
directive set /sobel_filter/core/ACC3 -UNROLL yes
directive set /sobel_filter/core/ACC1 -UNROLL yes
directive set /sobel_filter/core/SHIFT -UNROLL yes
directive set /sobel_filter/core/main -DISTRIBUTED_PIPELINE true
directive set /sobel_filter/core/main -PIPELINE_INIT_INTERVAL 1
