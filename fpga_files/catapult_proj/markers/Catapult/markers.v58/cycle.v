...
//  Generated date: Thu May 05 15:54:58 2016
// ----------------------------------------------------------------------
...
module markers_core (
  ...
  begin : core
    ...
    reg slc_4_svs_st;
    reg land_11_lpi_1_dfm_st;
    reg aif_33_aif_slc_itm;
          ...
          forever begin : main
            ...
            if ( main_stage_0_4 ) begin
              ...
              if ( land_13_lpi_1_dfm_st_1 ) begin
                ...
                if ( deltay_square_blue_acc_psp_sva[10] ) begin
                  ...
                  aif_39_land_sva_1 = ~ (readslicef_11_1_10((({1'b1 , (~ (deltay_square_blue_acc_psp_sva[9:0]))})
                      + 11'b101001)));
                end
              end
              land_12_lpi_1_dfm = aif_39_land_sva_1 & (~ (deltay_square_blue_acc_psp_sva[10]))
                  & land_13_lpi_1_dfm_1;
              vout_rsc_mgc_out_stdreg_d <= {(signext_10_1(~(aif_33_aif_slc_itm_1
                  | aif_33_slc_itm_1 | (~ land_11_lpi_1_dfm_2) | land_12_lpi_1_dfm)))
                  , 10'b0 , ({{9{land_12_lpi_1_dfm}}, land_12_lpi_1_dfm})};
            end
            if ( main_stage_0_3 ) begin
              land_13_sva_1 = 1'b0;
              land_9_sva_1 = 1'b0;
              if ( slc_4_svs_st_1 ) begin
                land_9_sva_1 = readslicef_12_1_11((conv_s2s_11_12(~ deltax_blue_acc_psp_sva_1)
                    + 12'b111111101101));
              end
              or_3_cse = land_8_lpi_1_dfm_1 | (land_9_sva_1 & slc_4_svs_1);
              ...
              if ( land_11_lpi_1_dfm_st_1 ) begin
                ...
                if ( deltay_square_red_acc_psp_sva[10] ) begin
                  ...
                  aif_33_aif_slc_itm = readslicef_11_1_10((({1'b1 , (~ (deltay_square_red_acc_psp_sva[9:0]))})
                      + 11'b101001));
                end
              end
              if ( deltax_square_blue_acc_psp_sva[10] ) begin
                ...
                land_13_sva_1 = ~ (readslicef_11_1_10((({1'b1 , (~ (deltax_square_blue_acc_psp_sva[9:0]))})
                    + 11'b101001)));
              end
              land_13_lpi_1_dfm = land_13_sva_1 & (~ (deltax_square_blue_acc_psp_sva[10]));
              land_13_lpi_1_dfm_st = land_13_lpi_1_dfm;
              aif_33_slc_itm = deltay_square_red_acc_psp_sva[10];
            ...
            if ( main_stage_0_2 ) begin
              ...
              if ( land_4_lpi_1_dfm_st_1 ) begin
                acc_7_1_sva_2 = acc_7_1_sva_dfm_2 + 4'b1;
              end
              acc_7_1_sva_dfm_1 = MUX_v_4_2_2({acc_7_1_sva_dfm_2 , acc_7_1_sva_2},
                  land_4_lpi_1_dfm_1);
              slc_2_svs = readslicef_5_1_4((({1'b1 , (~ acc_7_0_sva_dfm_1)}) + 5'b101));
              if ( slc_2_svs ) begin
              ...
              red_xy_1_sva_dfm_2 = MUX_v_10_2_2({red_xy_1_sva_dfm_3 , red_xy_1_sva_2},
                  and_6_cse);
              slc_3_svs = readslicef_5_1_4((({1'b1 , (~ acc_7_1_sva_dfm_1)}) + 5'b101));
              if ( slc_3_svs ) begin
              ...
              land_8_lpi_1_dfm = ~((~((blue_xy_0_sva_dfm_2[9]) | (blue_xy_0_sva_dfm_2[8])
              ...
              mux_13_nl = MUX_v_10_2_2({blue_xy_previous_0_sva , blue_xy_0_sva_dfm_2},
                  land_8_lpi_1_dfm);
              ...
              if ( deltax_square_red_acc_psp_sva[10] ) begin
                ...
                land_11_sva_1 = ~ (readslicef_11_1_10((({1'b1 , (~ (deltax_square_red_acc_psp_sva[9:0]))})
                    + 11'b101001)));
              end
              land_11_lpi_1_dfm = land_11_sva_1 & (~ (deltax_square_red_acc_psp_sva[10]));
              land_11_lpi_1_dfm_st = land_11_lpi_1_dfm;
              acc_7_0_sva = acc_7_0_sva_dfm_1;
              acc_7_1_sva = acc_7_1_sva_dfm_1;
            ...
            acc_7_1_sva_dfm_2 = acc_7_1_sva & ({{3{unequal_tmp}}, unequal_tmp});
            ...
            aif_33_aif_slc_itm_1 = aif_33_aif_slc_itm;
            aif_33_slc_itm_1 = aif_33_slc_itm;
            land_2_lpi_1_dfm_st_1 = land_2_lpi_1_dfm;
            land_4_lpi_1_dfm_st_1 = land_4_lpi_1_dfm;
            slc_4_svs_st_1 = slc_4_svs_st;
            land_11_lpi_1_dfm_st_1 = land_11_lpi_1_dfm_st;
    ...
    aif_33_aif_slc_itm = 1'b0;
    land_11_lpi_1_dfm_st = 1'b0;
    slc_4_svs_st = 1'b0;
