...
//  Generated date: Wed May 04 16:40:01 2016
// ----------------------------------------------------------------------
...
module markers_core (
  ...
  begin : core
    ...
    reg else_2_slc_svs;
    reg else_2_land_2_sva_1;
    reg else_2_land_2_lpi_1_dfm;
    reg else_2_aif_1_slc_svs;
    reg else_2_aif_1_land_sva_1;
    reg else_2_land_1_lpi_1_dfm;
    reg else_2_aif_2_slc_svs;
    reg else_2_aif_2_land_sva_1;
    reg else_2_land_lpi_1_dfm;
    reg [3:0] acc_5_1_sva_2;
    reg [3:0] acc_5_0_sva_dfm_1;
    reg [3:0] acc_5_1_sva_dfm_2;
    ...
    reg aif_31_slc_svs;
    reg aif_31_land_sva_1;
    reg land_6_lpi_1_dfm;
    reg [10:0] deltax_blue_acc_psp_sva;
    reg else_10_slc_svs;
    reg else_10_land_1_sva_1;
    reg else_10_land_1_lpi_1_dfm;
    reg [10:0] deltay_blue_acc_psp_sva;
    reg else_10_aif_1_slc_svs;
    reg else_10_aif_1_land_sva_1;
    reg unequal_tmp_5;
    ...
    reg land_1_lpi_1_dfm_st;
    reg else_2_land_2_lpi_1_dfm_st;
    reg else_2_aif_1_slc_svs_st;
    reg slc_4_svs_st;
    reg [6:0] if_10_slc_deltax_square_red_itm;
    reg [6:0] if_10_slc_deltax_square_red_itm_1;
    reg land_6_lpi_1_dfm_st;
    reg else_10_land_1_lpi_1_dfm_st;
    reg land_2_lpi_1_dfm_st_1;
    reg aif_7_slc_svs_st_1;
    reg land_1_lpi_1_dfm_st_1;
    reg else_2_land_2_lpi_1_dfm_st_1;
    reg else_2_aif_1_slc_svs_st_1;
    reg slc_4_svs_st_1;
    reg land_6_lpi_1_dfm_st_1;
    reg land_6_lpi_1_dfm_st_2;
    reg else_10_land_1_lpi_1_dfm_st_1;
    reg main_stage_0_2;
    reg main_stage_0_3;
    reg main_stage_0_4;
    reg main_stage_0_5;
        ...
        begin : mainExit
          forever begin : main
            ...
            if ( main_stage_0_6 ) begin
              else_10_aif_1_land_sva_1 = 1'b0;
              if ( land_6_lpi_1_dfm_st_2 ) begin
              end
              else if ( else_10_land_1_lpi_1_dfm_st_1 ) begin
                else_10_aif_1_slc_svs = readslicef_11_1_10(((~ deltay_blue_acc_psp_sva_1)
                    + 11'b1));
                if ( else_10_aif_1_slc_svs ) begin
                  else_10_aif_1_land_sva_1 = readslicef_8_1_7((conv_u2s_7_8(deltay_blue_acc_psp_sva_1[9:3])
                      + 8'b11111011));
                end
              end
              vout_rsc_mgc_out_stdreg_d <= {({{9{land_6_lpi_1_dfm_2}}, land_6_lpi_1_dfm_2})
                  , 10'b0 , (signext_10_1(else_10_aif_1_land_sva_1 & else_10_aif_1_slc_svs
                  & else_10_land_1_lpi_1_dfm_2 & (~ land_6_lpi_1_dfm_2)))};
            end
            if ( main_stage_0_5 ) begin
              else_10_land_1_sva_1 = 1'b0;
              if ( land_6_lpi_1_dfm_st_1 ) begin
              end
              else begin
                deltax_blue_acc_psp_sva = readslicef_12_11_1((({1'b1 , (vga_xy[9:0])
                    , 1'b1}) + conv_u2s_11_12({(~ blue_xy_0_sva_dfm_3) , 1'b1})));
                else_10_slc_svs = readslicef_11_1_10(((~ deltax_blue_acc_psp_sva)
                    + 11'b1));
                if ( else_10_slc_svs ) begin
                  else_10_land_1_sva_1 = readslicef_8_1_7((conv_u2s_7_8(deltax_blue_acc_psp_sva[9:3])
                      + 8'b11111011));
                end
                else_10_land_1_lpi_1_dfm = else_10_land_1_sva_1 & else_10_slc_svs;
                else_10_land_1_lpi_1_dfm_st = else_10_land_1_lpi_1_dfm;
                if ( else_10_land_1_lpi_1_dfm ) begin
                  deltay_blue_acc_psp_sva = readslicef_12_11_1((({1'b1 , (vga_xy[19:10])
                      , 1'b1}) + conv_u2s_11_12({(~ blue_xy_1_sva_dfm_3) , 1'b1})));
                end
              end
            end
            if ( main_stage_0_4 ) begin
              aif_31_land_sva_1 = 1'b0;
              land_7_sva_1 = 1'b0;
              if ( slc_4_svs_st_1 ) begin
                land_7_sva_1 = readslicef_8_1_7((conv_u2s_7_8(if_10_slc_deltax_square_red_itm_1)
                    + 8'b11111011));
              end
              land_7_lpi_1_dfm = land_7_sva_1 & slc_4_svs_1;
              if ( land_7_lpi_1_dfm ) begin
                deltay_square_red_acc_psp_sva = readslicef_12_11_1((({1'b1 , (vga_xy[19:10])
                    ...
                    1'b1})));
                aif_31_slc_svs = readslicef_11_1_10(((~ deltay_square_red_acc_psp_sva)
                    + 11'b1));
                if ( aif_31_slc_svs ) begin
                  aif_31_land_sva_1 = readslicef_8_1_7((conv_u2s_7_8(deltay_square_red_acc_psp_sva[9:3])
                      + 8'b11111011));
                end
              end
              land_6_lpi_1_dfm = aif_31_land_sva_1 & aif_31_slc_svs & land_7_lpi_1_dfm;
              land_6_lpi_1_dfm_st = land_6_lpi_1_dfm;
              blue_xy_0_sva = blue_xy_0_sva_dfm_2;
              blue_xy_1_sva = blue_xy_1_sva_dfm_2;
              red_xy_previous_1_sva = red_xy_previous_1_sva_dfm_2;
            end
            if ( main_stage_0_3 ) begin
              ...
              acc_5_1_sva_2 = 4'b0;
              else_2_aif_2_land_sva_1 = 1'b0;
              else_2_aif_1_land_sva_1 = 1'b0;
              if ( land_1_lpi_1_dfm_st_1 ) begin
              end
              else begin
                if ( else_2_land_2_lpi_1_dfm_st_1 ) begin
                  if ( else_2_aif_1_slc_svs_st_1 ) begin
                  end
                  else begin
                    else_2_aif_1_land_sva_1 = ~ (readslicef_8_1_7((conv_u2s_7_8(~
                        (vin[18:12])) + 8'b11110001)));
                  end
                end
                else_2_land_1_lpi_1_dfm = else_2_aif_1_land_sva_1 & (~ else_2_aif_1_slc_svs_1)
                    & else_2_land_2_lpi_1_dfm_2;
                if ( else_2_land_1_lpi_1_dfm ) begin
                  else_2_aif_2_slc_svs = readslicef_9_1_8((conv_u2s_8_9(vin[9:2])
                      + 9'b111001111));
                  if ( else_2_aif_2_slc_svs ) begin
                  end
                  else begin
                    else_2_aif_2_land_sva_1 = ~ (readslicef_8_1_7((({1'b1 , (~ (vin[9:3]))})
                        + 8'b1001011)));
                  end
                end
                else_2_land_lpi_1_dfm = else_2_aif_2_land_sva_1 & (~ else_2_aif_2_slc_svs)
                    & else_2_land_1_lpi_1_dfm;
                if ( else_2_land_lpi_1_dfm ) begin
                  acc_5_1_sva_2 = acc_5_1_sva_dfm_3 + 4'b1;
                end
              end
              acc_5_1_sva_dfm_2 = MUX_v_4_2_2({acc_5_1_sva_dfm_3 , acc_5_1_sva_2},
                  else_2_land_lpi_1_dfm & (~ land_1_lpi_1_dfm_1));
              if ( acc_5_1_sva_dfm_2[3] ) begin
              ...
              and_8_cse = if_6_land_lpi_1_dfm & (acc_5_1_sva_dfm_2[3]);
              ...
              blue_xy_1_sva_dfm_1 = MUX_v_10_2_2({blue_xy_1_sva , blue_xy_1_sva_1},
                  and_8_cse);
              slc_3_svs = readslicef_10_1_9((conv_s2u_9_10(deltax_red_acc_psp_sva_1[10:2])
                  + 10'b1111111011));
              if ( slc_3_svs ) begin
                land_5_sva_1 = readslicef_12_1_11((conv_s2s_11_12(~ deltax_red_acc_psp_sva_1)
                    + 12'b111111101101));
              end
              or_5_cse = land_4_lpi_1_dfm_1 | (land_5_sva_1 & slc_3_svs);
              red_xy_previous_0_sva_dfm_1 = MUX_v_10_2_2({red_xy_previous_0_sva ,
                  red_xy_0_sva_dfm_4}, or_5_cse);
              red_xy_previous_1_sva_dfm_1 = MUX_v_10_2_2({red_xy_previous_1_sva ,
                  red_xy_1_sva_dfm_4}, or_5_cse);
              deltax_square_red_acc_psp_sva = readslicef_12_11_1((({1'b1 , (vga_xy[9:0])
                  , 1'b1}) + conv_u2s_11_12({(~ red_xy_previous_0_sva_dfm_1) , 1'b1})));
              slc_4_svs = readslicef_11_1_10(((~ deltax_square_red_acc_psp_sva) +
                  11'b1));
              slc_4_svs_st = slc_4_svs;
              if ( slc_4_svs ) begin
                if_10_slc_deltax_square_red_itm = deltax_square_red_acc_psp_sva[9:3];
              end
              acc_5_1_sva = acc_5_1_sva_dfm_2;
              red_xy_previous_0_sva = red_xy_previous_0_sva_dfm_1;
            end
            if ( main_stage_0_2 ) begin
              red_xy_1_sva_2 = 10'b0;
              red_xy_0_sva_2 = 10'b0;
              else_2_land_2_sva_1 = 1'b0;
              aif_7_land_sva_1 = 1'b0;
              acc_5_1_sva_dfm = acc_5_1_sva & ({{3{unequal_tmp_5}}, unequal_tmp_5});
              ...
              land_1_lpi_1_dfm = aif_7_land_sva_1 & (~ aif_7_slc_svs_1) & land_2_lpi_1_dfm_1;
              land_1_lpi_1_dfm_st = land_1_lpi_1_dfm;
              if ( land_1_lpi_1_dfm ) begin
                acc_5_0_sva_dfm_1 = acc_5_0_sva_dfm_2 + 4'b1;
              end
              else begin
                else_2_slc_svs = readslicef_9_1_8((conv_u2s_8_9(vin[29:22]) + 9'b101011011));
                if ( else_2_slc_svs ) begin
                end
                else begin
                  else_2_land_2_sva_1 = ~ (readslicef_8_1_7((conv_u2s_7_8(~ (vin[28:22]))
                      + 8'b11011111)));
                end
                else_2_land_2_lpi_1_dfm = else_2_land_2_sva_1 & (~ else_2_slc_svs);
                else_2_land_2_lpi_1_dfm_st = else_2_land_2_lpi_1_dfm;
                if ( else_2_land_2_lpi_1_dfm ) begin
                  else_2_aif_1_slc_svs = readslicef_9_1_8((conv_u2s_8_9(vin[19:12])
                      + 9'b101000111));
                  else_2_aif_1_slc_svs_st = else_2_aif_1_slc_svs;
                end
                acc_5_0_sva_dfm_1 = acc_5_0_sva_dfm_2;
              end
              if ( acc_5_0_sva_dfm_1[3] ) begin
              ...
              nand_cse = ~((~((~ if_4_land_lpi_1_dfm) & (acc_5_0_sva_dfm_1[3])))
                  & (acc_5_0_sva_dfm_1[3]));
              red_xy_0_sva_dfm_2 = MUX_v_10_2_2({red_xy_0_sva_2 , red_xy_0_sva_dfm_3},
                  nand_cse);
              red_xy_1_sva_dfm_2 = MUX_v_10_2_2({red_xy_1_sva_2 , red_xy_1_sva_dfm_3},
                  nand_cse);
              land_4_lpi_1_dfm = ~((~((red_xy_0_sva_dfm_2[9]) | (red_xy_0_sva_dfm_2[8])
              ...
              mux_17_nl = MUX_v_10_2_2({red_xy_previous_0_sva , red_xy_0_sva_dfm_2},
                  land_4_lpi_1_dfm);
              deltax_red_acc_psp_sva = readslicef_12_11_1((({1'b1 , red_xy_0_sva_dfm_2
                  , 1'b1}) + conv_u2s_11_12({(~ (mux_17_nl)) , 1'b1})));
              acc_5_0_sva = acc_5_0_sva_dfm_1;
            ...
            acc_5_0_sva_dfm_2 = acc_5_0_sva & ({{3{unequal_tmp}}, unequal_tmp});
            acc_5_1_sva_dfm_3 = acc_5_1_sva_dfm;
            ...
            else_2_land_2_lpi_1_dfm_2 = else_2_land_2_lpi_1_dfm;
            else_2_aif_1_slc_svs_1 = else_2_aif_1_slc_svs;
            ...
            land_6_lpi_1_dfm_2 = land_6_lpi_1_dfm_1;
            land_6_lpi_1_dfm_1 = land_6_lpi_1_dfm;
            else_10_land_1_lpi_1_dfm_2 = else_10_land_1_lpi_1_dfm;
            deltay_blue_acc_psp_sva_1 = deltay_blue_acc_psp_sva;
            if_10_slc_deltax_square_red_itm_1 = if_10_slc_deltax_square_red_itm;
            land_2_lpi_1_dfm_st_1 = land_2_lpi_1_dfm;
            aif_7_slc_svs_st_1 = aif_7_slc_svs_st;
            land_1_lpi_1_dfm_st_1 = land_1_lpi_1_dfm_st;
            else_2_land_2_lpi_1_dfm_st_1 = else_2_land_2_lpi_1_dfm_st;
            else_2_aif_1_slc_svs_st_1 = else_2_aif_1_slc_svs_st;
            slc_4_svs_st_1 = slc_4_svs_st;
            land_6_lpi_1_dfm_st_2 = land_6_lpi_1_dfm_st_1;
            land_6_lpi_1_dfm_st_1 = land_6_lpi_1_dfm_st;
            else_10_land_1_lpi_1_dfm_st_1 = else_10_land_1_lpi_1_dfm_st;
    ...
    main_stage_0_3 = 1'b0;
    main_stage_0_2 = 1'b0;
    else_10_land_1_lpi_1_dfm_st_1 = 1'b0;
    land_6_lpi_1_dfm_st_2 = 1'b0;
    land_6_lpi_1_dfm_st_1 = 1'b0;
    slc_4_svs_st_1 = 1'b0;
    else_2_aif_1_slc_svs_st_1 = 1'b0;
    else_2_land_2_lpi_1_dfm_st_1 = 1'b0;
    land_1_lpi_1_dfm_st_1 = 1'b0;
    aif_7_slc_svs_st_1 = 1'b0;
    land_2_lpi_1_dfm_st_1 = 1'b0;
    else_10_land_1_lpi_1_dfm_st = 1'b0;
    land_6_lpi_1_dfm_st = 1'b0;
    if_10_slc_deltax_square_red_itm_1 = 7'b0;
    if_10_slc_deltax_square_red_itm = 7'b0;
    slc_4_svs_st = 1'b0;
    else_2_aif_1_slc_svs_st = 1'b0;
    else_2_land_2_lpi_1_dfm_st = 1'b0;
    land_1_lpi_1_dfm_st = 1'b0;
    ...
    deltay_blue_acc_psp_sva = 11'b0;
    else_10_land_1_lpi_1_dfm = 1'b0;
    else_10_land_1_sva_1 = 1'b0;
    else_10_slc_svs = 1'b0;
    ...
    acc_5_1_sva_dfm_2 = 4'b0;
    acc_5_0_sva_dfm_1 = 4'b0;
    acc_5_1_sva_2 = 4'b0;
