...
//  Generated date: Wed May 04 14:21:28 2016
// ----------------------------------------------------------------------
      ...
      forever begin : core_rlp
        ...
        begin : mainExit
          forever begin : main
            ...
            land_2_sva_1 = 1'b0;
            if_acc_5_sdt = conv_u2u_3_4(conv_u2u_2_3(vga_xy[3:2]) + conv_u2u_2_3(~
                (vga_xy[5:4]))) + conv_u2u_3_4(conv_u2u_2_3(vga_xy[7:6]) + conv_u2u_2_3(~
                (vga_xy[9:8])));
            if_acc_7_psp = (if_acc_5_sdt[3:1]) + 3'b101;
            if_acc_1_psp_sva = conv_s2u_2_3(conv_s2s_1_2(~ (if_acc_7_psp[2])) + conv_u2s_1_2(~
            ...
            acc_2_0_sva_dfm = acc_2_0_sva & (signext_4_1(~((if_acc_sdt_sva[2]) |
                (if_acc_sdt_sva[1]) | (if_acc_sdt_sva[0]) | (vga_xy[1]) | (vga_xy[0]))));
            ...
            if ( land_lpi_1_dfm ) begin
              acc_2_0_sva_2 = acc_2_0_sva_dfm + 4'b1;
            end
            else begin
              ...
              if ( else_1_land_2_lpi_1_dfm ) begin
                else_1_aif_1_slc_svs = readslicef_9_1_8((conv_u2s_8_9(vin[19:12])
                    + 9'b101000111));
                if ( else_1_aif_1_slc_svs ) begin
                end
                else begin
                  else_1_aif_1_land_sva_1 = ~ (readslicef_8_1_7((conv_u2s_7_8(~ (vin[18:12]))
                      + 8'b11110001)));
                end
              end
              else_1_land_1_lpi_1_dfm = else_1_aif_1_land_sva_1 & (~ else_1_aif_1_slc_svs)
                  & else_1_land_2_lpi_1_dfm;
              ...
              if ( else_1_land_lpi_1_dfm ) begin
                acc_2_0_sva_3 = acc_2_0_sva_dfm + 4'b1;
              end
            end
            acc_2_0_sva_dfm_2 = MUX1HOT_v_4_3_2({acc_2_0_sva_2 , acc_2_0_sva_3 ,
                acc_2_0_sva_dfm}, {land_lpi_1_dfm , (else_1_land_lpi_1_dfm & (~ land_lpi_1_dfm))
                , (~(else_1_land_lpi_1_dfm | land_lpi_1_dfm))});
            slc_1_svs = readslicef_4_1_3((({1'b1 , (~ (acc_2_0_sva_dfm_2[3:1]))})
                + 4'b11));
            if ( slc_1_svs ) begin
