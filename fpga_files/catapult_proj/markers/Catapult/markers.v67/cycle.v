...
//  Generated date: Thu May 05 18:07:51 2016
// ----------------------------------------------------------------------
      ...
      forever begin : core_rlp
        ...
        begin : mainExit
          forever begin : main
            ...
            aif_11_slc_svs = readslicef_9_1_8((({1'b1 , (~ (vin[29:22]))}) + 9'b1011011));
            if ( aif_11_slc_svs ) begin
            end
            else begin
              land_5_sva_1 = ~ (readslicef_9_1_8((({1'b1 , (~ (vin[19:12]))}) + 9'b1011011)));
            end
            land_5_lpi_1_dfm = land_5_sva_1 & (~ aif_11_slc_svs);
            if ( land_5_lpi_1_dfm ) begin
              land_4_sva_1 = ~ (readslicef_8_1_7((conv_u2u_7_8(vin[9:3]) + 8'b11001001)));
            end
