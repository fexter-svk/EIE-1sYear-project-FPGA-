...
directive set /markers/core/core:rlp/main/asn#100 CSTEPS_FROM {{.. == 1}}
...
directive set /markers/core/core:rlp/main/if#1:acc CSTEPS_FROM {{.. == 1}}
...
directive set /markers/core/core:rlp/main/if#3:acc CSTEPS_FROM {{.. == 1}}
