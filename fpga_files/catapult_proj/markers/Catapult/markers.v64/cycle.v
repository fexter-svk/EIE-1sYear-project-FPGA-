...
//  Generated date: Thu May 05 16:59:03 2016
// ----------------------------------------------------------------------
      ...
      forever begin : core_rlp
        ...
        begin : mainExit
          forever begin : main
            ...
            aif_11_slc_svs = readslicef_9_1_8((({1'b1 , (~ (vin[29:22]))}) + 9'b101001));
            if ( aif_11_slc_svs ) begin
            end
            else begin
              aif_13_slc_svs = readslicef_8_1_7((conv_u2u_7_8(vin[19:13]) + 8'b11100111));
