...
//  Generated date: Wed May 04 14:34:23 2016
// ----------------------------------------------------------------------
      ...
      forever begin : core_rlp
        ...
        begin : mainExit
          forever begin : main
            ...
            acc_3_1_sva_dfm = acc_3_1_sva & (signext_4_1((if_acc_sdt_sva[2]) | (if_acc_sdt_sva[1])
            ...
            if ( land_lpi_1_dfm ) begin
              ...
              if ( else_1_land_lpi_1_dfm ) begin
                acc_3_1_sva_2 = acc_3_1_sva_dfm + 4'b1;
              end
            end
            acc_3_1_sva_dfm_2 = MUX_v_4_2_2({acc_3_1_sva_dfm , acc_3_1_sva_2}, else_1_land_lpi_1_dfm
                & (~ land_lpi_1_dfm));
            slc_2_svs = readslicef_5_1_4((({1'b1 , (~ acc_3_1_sva_dfm_2)}) + 5'b111));
            if ( slc_2_svs ) begin
              red_out_sg1_sva = vin[29:22];
              green_out_sg1_sva = vin[19:12];
              blue_out_sg1_sva = vin[9:2];
            end
            vout_rsc_mgc_out_stdreg_d <= {(red_out_sg1_sva & ({{7{slc_2_svs}}, slc_2_svs}))
                , 2'b0 , (green_out_sg1_sva & ({{7{slc_2_svs}}, slc_2_svs})) , 2'b0
                , (blue_out_sg1_sva & ({{7{slc_2_svs}}, slc_2_svs})) , 2'b0};
