...
//  Generated date: Fri May 06 15:20:11 2016
// ----------------------------------------------------------------------
...
module markers_core (
  ...
  begin : core
    ...
    reg [3:0] volume_current_slc_acc_tmp_itm;
    reg [3:0] volume_current_slc_acc_tmp_itm_1;
    reg volume_current_and_itm;
          ...
          forever begin : main
            ...
            if ( main_stage_0_3 ) begin
              ...
              land_13_lpi_1_dfm = aif_47_land_sva_1 & (~ (deltay_square_blue_acc_psp_sva[10]))
                  & land_14_lpi_1_dfm_1;
              volume_current_sva = volume_current_slc_acc_tmp_itm_1 + conv_u2u_1_4(volume_current_and_itm_1);
            ...
            if ( main_stage_0_2 ) begin
              ...
              volume_current_acc_psp = conv_u2u_10_11(volume_current_acc_sdt[10:1])
                  + 11'b10111100001;
              volume_current_slc_acc_tmp_itm = volume_current_acc_psp[9:6];
              volume_current_and_itm = (volume_current_acc_psp[10]) & ((volume_current_acc_psp[5])
            ...
            volume_current_slc_acc_tmp_itm_1 = volume_current_slc_acc_tmp_itm;
            volume_current_and_itm_1 = volume_current_and_itm;
    ...
    volume_current_and_itm = 1'b0;
    volume_current_slc_acc_tmp_itm_1 = 4'b0;
    volume_current_slc_acc_tmp_itm = 4'b0;
