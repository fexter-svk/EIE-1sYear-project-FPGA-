...
directive set /markers/core/core:rlp/main/else#2:if:acc#2 CSTEPS_FROM {{.. == 2}}
...
directive set /markers/core/core:rlp/main/if#11:acc CSTEPS_FROM {{.. == 3}}
...
directive set /markers/core/core:rlp/main/aif#39:acc CSTEPS_FROM {{.. == 4}}
