...
//  Generated date: Fri May 06 15:34:12 2016
// ----------------------------------------------------------------------
...
module markers_core (
  ...
  begin : core
    ...
    reg [5:0] conc_imod_sg1_sva;
    reg [4:0] conc_imod_1_sg1_sva;
    ...
    reg volume_current_slc_acc_idiv_itm;
        ...
        begin : mainExit
          forever begin : main
            ...
            if ( main_stage_0_4 ) begin
              land_15_sva_1 = 1'b0;
              volume_current_sva = (readslicef_5_4_1((conv_s2s_4_5({(readslicef_4_3_1((conv_s2s_3_4({volume_current_slc_acc_idiv_12_itm_2
                  , 1'b1}) + conv_s2s_3_4({1'b1 , volume_current_slc_acc_idiv_10_itm_2
                  , volume_current_nand_itm_1})))) , 1'b1}) + conv_u2s_3_5({volume_current_slc_2_itm_1
                  , and_1_itm_1})))) + ({volume_current_slc_acc_idiv_13_itm_2 , volume_current_slc_acc_idiv_14_itm_2});
            ...
            if ( main_stage_0_3 ) begin
              ...
              land_13_lpi_1_dfm = aif_47_land_sva_1 & (~ (deltay_square_blue_acc_psp_sva[10]))
                  & land_14_lpi_1_dfm_1;
              conc_imod_sg1_sva = (({5'b10100 , (~ volume_current_slc_acc_idiv_itm_1)})
                  + conv_u2s_5_6(({(conv_u2u_1_2(~ volume_current_slc_acc_idiv_4_itm_1)
                  + conv_u2u_1_2(volume_current_slc_acc_idiv_6_itm_1) + 2'b1) , 1'b1
                  , (({1'b1 , (~ volume_current_slc_acc_idiv_5_itm_1)}) + 2'b11)})
                  + ({slc_acc_idiv_1_itm_1 , 1'b0 , slc_acc_idiv_2_itm_1 , 1'b0 ,
                  slc_acc_idiv_itm_1}))) + (conv_s2s_4_6(conv_s2s_3_4({volume_current_slc_acc_idiv_2_itm_1
                  , 1'b1}) + conv_s2s_2_4(volume_current_slc_acc_idiv_1_itm_1)) +
                  conv_u2s_4_6(volume_current_slc_acc_idiv_3_itm_1));
              conc_imod_1_sg1_sva = (conv_u2u_4_5({3'b100 , (conc_imod_sg1_sva[5])})
                  ...
                  , 3'b1}));
              volume_current_nand_itm = ~((conc_imod_1_sg1_sva[4]) & (~ volume_current_slc_acc_idiv_8_itm_1));
              volume_current_slc_2_itm = readslicef_3_2_1((conv_u2u_2_3({volume_current_slc_acc_idiv_11_itm_1
                  , 1'b1}) + conv_u2u_2_3({(conc_imod_sg1_sva[4]) , (~ (conc_imod_sg1_sva[5]))})));
              and_1_itm = volume_current_slc_acc_idiv_9_itm_1 & (~ (conc_imod_1_sg1_sva[4]))
                  & ((conc_imod_1_sg1_sva[3]) | (conc_imod_1_sg1_sva[2]) | (conc_imod_1_sg1_sva[1])
                  | (conc_imod_1_sg1_sva[0]) | volume_current_slc_acc_idiv_15_itm_1
                  | volume_current_slc_acc_idiv_16_itm_1 | volume_current_slc_acc_idiv_7_itm_1);
            ...
            if ( main_stage_0_2 ) begin
              ...
              acc_12_1_sva_2 = 4'b0;
              acc_12_0_sva_dfm_1 = MUX_v_4_2_2({acc_12_0_sva_dfm_2 , acc_12_0_sva_3},
                  land_2_lpi_1_dfm_1);
              ...
              volume_current_acc_psp = conv_u2u_10_11(volume_current_acc_sdt[10:1])
                  + 11'b10111100001;
              volume_current_slc_acc_idiv_itm = volume_current_acc_psp[7];
              volume_current_slc_acc_idiv_4_itm = volume_current_acc_psp[6];
              volume_current_slc_acc_idiv_5_itm = volume_current_acc_psp[6];
              volume_current_slc_acc_idiv_6_itm = volume_current_acc_psp[7];
              slc_acc_idiv_1_itm = volume_current_acc_psp[8];
              slc_acc_idiv_2_itm = volume_current_acc_psp[8];
              slc_acc_idiv_itm = volume_current_acc_psp[8];
              volume_current_slc_acc_idiv_2_itm = volume_current_acc_psp[10:9];
              volume_current_slc_acc_idiv_1_itm = volume_current_acc_psp[10:9];
              volume_current_slc_acc_idiv_3_itm = volume_current_acc_psp[5:2];
              volume_current_slc_acc_idiv_12_itm = volume_current_acc_psp[10:9];
              volume_current_slc_acc_idiv_10_itm = volume_current_acc_psp[7];
              volume_current_slc_acc_idiv_8_itm = volume_current_acc_psp[10];
              volume_current_slc_acc_idiv_11_itm = volume_current_acc_psp[8];
              volume_current_slc_acc_idiv_9_itm = volume_current_acc_psp[10];
              volume_current_slc_acc_idiv_15_itm = volume_current_acc_psp[1];
              volume_current_slc_acc_idiv_16_itm = volume_current_acc_psp[0];
              volume_current_slc_acc_idiv_7_itm = volume_current_acc_sdt[0];
              volume_current_slc_acc_idiv_13_itm = volume_current_acc_psp[10:8];
              volume_current_slc_acc_idiv_14_itm = volume_current_acc_psp[6];
            ...
            if ( land_2_lpi_1_dfm ) begin
              acc_12_0_sva_2 = acc_12_0_sva_dfm + 4'b1;
            end
            ...
            volume_current_nand_itm_1 = volume_current_nand_itm;
            volume_current_slc_acc_idiv_11_itm_1 = volume_current_slc_acc_idiv_11_itm;
            volume_current_slc_2_itm_1 = volume_current_slc_2_itm;
            volume_current_slc_acc_idiv_9_itm_1 = volume_current_slc_acc_idiv_9_itm;
            volume_current_slc_acc_idiv_15_itm_1 = volume_current_slc_acc_idiv_15_itm;
            volume_current_slc_acc_idiv_16_itm_1 = volume_current_slc_acc_idiv_16_itm;
            ...
            volume_current_slc_acc_idiv_14_itm_2 = volume_current_slc_acc_idiv_14_itm_1;
    ...
    volume_current_slc_acc_idiv_itm = 1'b0;
    ...
    conc_imod_1_sg1_sva = 5'b0;
    conc_imod_sg1_sva = 6'b0;
