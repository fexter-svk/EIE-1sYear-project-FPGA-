...
directive set /markers/core/core:rlp/main/asn#216 CSTEPS_FROM {{.. == 3}}
directive set /markers/core/core:rlp/main/asn#217 CSTEPS_FROM {{.. == 3}}
...
directive set /markers/core/core:rlp/main/acc#13 CSTEPS_FROM {{.. == 1}}
...
directive set /markers/core/core:rlp/main/volume_current:acc CSTEPS_FROM {{.. == 2}}
directive set /markers/core/core:rlp/main/acc#9 CSTEPS_FROM {{.. == 2}}
directive set /markers/core/core:rlp/main/volume_current:acc#4 CSTEPS_FROM {{.. == 3}}
directive set /markers/core/core:rlp/main/volume_current:acc#6 CSTEPS_FROM {{.. == 3}}
directive set /markers/core/core:rlp/main/volume_current:acc#5 CSTEPS_FROM {{.. == 3}}
directive set /markers/core/core:rlp/main/volume_current:acc#1 CSTEPS_FROM {{.. == 3}}
directive set /markers/core/core:rlp/main/volume_current:acc#7 CSTEPS_FROM {{.. == 3}}
directive set /markers/core/core:rlp/main/volume_current:acc#2 CSTEPS_FROM {{.. == 3}}
directive set /markers/core/core:rlp/main/volume_current:acc#9 CSTEPS_FROM {{.. == 3}}
directive set /markers/core/core:rlp/main/volume_current:acc#8 CSTEPS_FROM {{.. == 3}}
directive set /markers/core/core:rlp/main/volume_current:acc#11 CSTEPS_FROM {{.. == 4}}
directive set /markers/core/core:rlp/main/volume_current:acc#13 CSTEPS_FROM {{.. == 4}}
directive set /markers/core/core:rlp/main/volume_current:acc#10 CSTEPS_FROM {{.. == 3}}
directive set /markers/core/core:rlp/main/volume_current:acc#12 CSTEPS_FROM {{.. == 4}}
directive set /markers/core/core:rlp/main/volume_current:acc#3 CSTEPS_FROM {{.. == 4}}
directive set /markers/core/core:rlp/main/if#14:acc#1 CSTEPS_FROM {{.. == 4}}
directive set /markers/core/core:rlp/main/if#14:acc CSTEPS_FROM {{.. == 4}}
directive set /markers/core/core:rlp/main/aif#51:acc CSTEPS_FROM {{.. == 4}}
directive set /markers/core/core:rlp/main/mux#14 CSTEPS_FROM {{.. == 4}}
