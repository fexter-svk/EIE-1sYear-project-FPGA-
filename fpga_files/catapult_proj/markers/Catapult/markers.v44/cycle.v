...
//  Generated date: Wed May 04 15:16:22 2016
// ----------------------------------------------------------------------
          ...
          forever begin : main
            ...
            if ( main_stage_0_3 ) begin
              ...
              if ( slc_3_svs_st_1 ) begin
                land_3_sva_1 = readslicef_11_1_10((conv_s2s_10_11(readslicef_12_10_2((({1'b1
                    , (vga_xy[19:10]) , 1'b1}) + conv_u2s_11_12({(~ green_xy_1_sva_dfm_4)
                    , 1'b1})))) + 11'b11111110001));
              end
              vout_rsc_mgc_out_stdreg_d <= {(signext_10_1(land_3_sva_1 & slc_3_svs_1))
                  , 20'b0};
            end
            if ( main_stage_0_2 ) begin
              ...
              if ( aif_5_land_sva_1 & (~ aif_5_slc_svs_1) & land_1_lpi_1_dfm_1 )
                  begin
            ...
            unequal_tmp_1 = (vga_xy[19]) | (vga_xy[18]) | (vga_xy[17]) | (vga_xy[16])
            ...
            green_xy_0_sva_dfm_3 = green_xy_0_sva & ({{9{unequal_tmp_1}}, unequal_tmp_1});
            green_xy_1_sva_dfm_3 = green_xy_1_sva & ({{9{unequal_tmp_1}}, unequal_tmp_1});
