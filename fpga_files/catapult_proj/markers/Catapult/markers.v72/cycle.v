...
//  Generated date: Fri May 06 10:10:50 2016
// ----------------------------------------------------------------------
          ...
          forever begin : main
            ...
            if ( main_stage_0_3 ) begin
              ...
              land_13_lpi_1_dfm = aif_47_land_sva_1 & (~ (deltay_square_blue_acc_psp_sva[10]))
                  & land_14_lpi_1_dfm_1;
              vout_rsc_mgc_out_stdreg_d <= {(signext_10_1(~(aif_41_aif_slc_itm_2
            ...
            if ( aif_39_slc_svs ) begin
              ...
              aif_41_aif_slc_itm = readslicef_11_1_10((({1'b1 , (~ (vga_xy[19:10]))})
                  + 11'b101001));
            end
            acc_10_1_sva_dfm_2 = acc_10_1_sva & (signext_4_1((if_acc_svs[3]) | (if_acc_svs[2])
