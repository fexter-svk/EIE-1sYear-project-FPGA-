...
//  Generated date: Sat May 07 14:12:50 2016
// ----------------------------------------------------------------------
...
module gauss_blur_core (
  ...
  begin : core
    ...
    reg [28:0] mul_itm;
    reg or_itm_1;
    reg aif_11_slc_svs_st;
    reg [8:0] or_3_itm;
    reg [8:0] or_3_itm_1;
    reg [9:0] if_4_slc_vga_xy_1_itm_1;
    reg aif_11_slc_svs_st_1;
    reg main_stage_0_2;
    reg main_stage_0_3;
        ...
        begin : mainExit
          forever begin : main
            ...
            if ( main_stage_0_3 ) begin
              ...
              land_5_sva_1 = 1'b0;
              if ( aif_11_slc_svs_st_1 ) begin
              end
              else begin
                land_5_sva_1 = ~ (readslicef_11_1_10((({1'b1 , (~ (acc_2_psp_sva_2[19:10]))})
                    + 11'b101000001)));
              end
              land_5_lpi_1_dfm = land_5_sva_1 & (~ aif_11_slc_svs_1);
              if ( land_5_lpi_1_dfm ) begin
                aif_17_slc_svs = readslicef_8_1_7((conv_u2u_7_8(acc_2_psp_sva_2[9:3])
                    + 8'b11010011));
                if ( aif_17_slc_svs ) begin
                end
                else begin
                  aif_17_land_sva_1 = ~ (readslicef_11_1_10((({1'b1 , (~ (acc_2_psp_sva_2[9:0]))})
                      + 11'b1011010001)));
                end
              end
              if ( aif_17_land_sva_1 & (~ aif_17_slc_svs) & land_5_lpi_1_dfm ) begin
                acc_16_1_sva_dfm_1 = acc_16_1_sva_dfm_2 + 4'b1;
              end
              else begin
                acc_16_1_sva_dfm_1 = acc_16_1_sva_dfm_2;
              end
              slc_3_svs = readslicef_5_1_4((({1'b1 , (~ acc_16_1_sva_dfm_1)}) + 5'b101));
              if ( slc_3_svs ) begin
                if_9_land_lpi_1_dfm = ~((blue_xy_1_sva_dfm_3[9]) | (blue_xy_1_sva_dfm_3[8])
              ...
              acc_12_psp_sva = conv_u2s_10_11(~ blue_xy_1_sva_dfm_2) + 11'b11111000001;
              conc_imod_sg1_sva = (conv_u2s_6_7({(conv_u2u_2_3(acc_12_psp_sva[9:8])
                  + conv_u2u_2_3({(acc_12_psp_sva[10]) , (acc_12_psp_sva[10])}))
                  , (acc_12_psp_sva[10:8])}) + conv_s2s_6_7({(acc_12_psp_sva[7])
                  , 1'b0 , (acc_12_psp_sva[7]) , 2'b0 , (acc_12_psp_sva[7])})) +
              ...
              volume_current_sva = conv_s2u_3_4(readslicef_4_3_1((conv_u2s_3_4({(readslicef_3_2_1((conv_u2u_2_3({(conc_imod_sg1_sva[5])
                  ...
                  & (~ (acc_12_psp_sva[10]))))})))) , 1'b1}) + conv_s2s_3_4({1'b1
                  , (acc_12_psp_sva[7]) , ((acc_12_psp_sva[10]) & (~ (conc_imod_1_sg1_sva[5]))
                  & ((conc_imod_1_sg1_sva[4]) | (conc_imod_1_sg1_sva[3]) | (conc_imod_1_sg1_sva[2])
                  | (conc_imod_1_sg1_sva[1]) | (conc_imod_1_sg1_sva[0]) | (acc_12_psp_sva[1])
                  | (acc_12_psp_sva[0])))})))) + conv_s2u_3_4(acc_12_psp_sva[10:8]);
              acc_14_cse_sva = readslicef_6_5_1((({1'b1 , volume_current_sva , 1'b1})
                  + conv_u2s_5_6({(~ volume_previous_sva) , 1'b1})));
              slc_8_svs = readslicef_5_1_4((conv_s2u_4_5(acc_14_cse_sva[4:1]) + 5'b1));
              if ( slc_8_svs ) begin
              end
              else begin
                land_15_sva_1 = ~ (readslicef_6_1_5((conv_s2s_5_6(~ acc_14_cse_sva)
                    + 6'b11)));
              end
              ...
              vout_rsc_mgc_out_stdreg_d <= {land_11_lpi_1_dfm_2 , or_3_itm_1 , (acc_2_psp_sva_2[19:10])
                  , ((acc_2_psp_sva_2[9:0]) | (signext_10_1(aif_47_land_sva_1 & (~
                  (deltay_square_blue_acc_psp_sva[10])) & land_14_lpi_1_dfm)))};
              acc_16_1_sva = acc_16_1_sva_dfm_1;
            ...
            if ( main_stage_0_2 ) begin
              land_sva_1 = 1'b0;
              acc_2_psp_sva = conv_s2u_28_29(conv_u2s_27_28(mul_7_itm_1) + conv_s2s_25_28(conv_u2s_24_25(mul_6_itm_1)
                  ...
                  , 1'b1}) + conv_s2s_6_9({slc_13_itm_1 , (~ slc_11_itm_1)})))))))))))
                  + ({mul_itm_1_sg8 , 1'b0 , mul_itm_1_sg6 , 1'b0 , mul_itm_1_sg4
                  , 1'b0 , mul_itm_1_sg2 , 1'b0 , mul_itm_2});
              acc_16_1_sva_dfm = acc_16_1_sva & ({{3{or_itm_1}}, or_itm_1});
              case (if_4_slc_vga_xy_1_itm_1)
                10'b0 : begin
              ...
              aif_11_slc_svs = readslicef_10_1_9((({1'b1 , (~ (acc_2_psp_sva[28:20]))})
                  + 10'b101000001));
              aif_11_slc_svs_st = aif_11_slc_svs;
              or_3_itm = (acc_2_psp_sva[28:20]) | ({{8{land_11_lpi_1_dfm_1}}, land_11_lpi_1_dfm_1});
              regs_regs_0_sva = vin;
            end
            land_11_sva_1 = 1'b0;
            gauss_blur_val_2_sva = ((conv_u2u_31_32(conv_u2u_30_31(regs_regs_1_sva[59:30])
                + conv_u2u_30_31(regs_regs_1_sva[29:0])) + conv_u2u_30_32(vin[89:60]))
                + conv_u2u_31_32(conv_u2u_30_31(vin[59:30]) + conv_u2u_30_31(vin[29:0])))
                + (conv_u2u_31_32(conv_u2u_30_31(regs_regs_0_sva[89:60]) + conv_u2u_30_31(regs_regs_0_sva[59:30]))
                + conv_u2u_31_32(conv_u2u_30_31(regs_regs_0_sva[29:0]) + conv_u2u_30_31(regs_regs_1_sva[89:60])));
            acc_imod_sva = (conv_u2u_6_7(conv_u2u_5_6(conv_u2u_4_5(conv_u2u_3_4(gauss_blur_val_2_sva[20:18])
                + conv_u2u_3_4(~ (gauss_blur_val_2_sva[23:21]))) + conv_u2u_4_5(readslicef_5_4_1((conv_u2u_4_5({(gauss_blur_val_2_sva[26:24])
                , 1'b1}) + conv_u2u_4_5({(~ (gauss_blur_val_2_sva[29:27])) , 1'b1})))))
                + conv_u2u_4_6(conv_u2u_3_4(gauss_blur_val_2_sva[2:0]) + conv_u2u_3_4(~
                (gauss_blur_val_2_sva[5:3])))) + conv_u2u_5_7(conv_u2u_4_5(conv_u2u_3_4(gauss_blur_val_2_sva[8:6])
                + conv_u2u_3_4(~ (gauss_blur_val_2_sva[11:9]))) + conv_u2u_4_5(conv_u2u_3_4(gauss_blur_val_2_sva[14:12])
                + conv_u2u_3_4(~ (gauss_blur_val_2_sva[17:15]))))) + ({5'b10111 ,
                (gauss_blur_val_2_sva[31:30])});
            mul_itm = conv_u2u_58_29(conv_u2u_2_29(gauss_blur_val_2_sva[31:30]) *
                29'b111000111000111000111000111);
            ...
            acc_16_1_sva_dfm_2 = acc_16_1_sva_dfm;
            blue_xy_0_sva_dfm_3 = blue_xy_0_sva_dfm;
            blue_xy_1_sva_dfm_3 = blue_xy_1_sva_dfm;
            aif_11_slc_svs_1 = aif_11_slc_svs;
            land_11_lpi_1_dfm_2 = land_11_lpi_1_dfm_1;
            land_11_lpi_1_dfm_1 = land_11_sva_1 & (~ aif_39_slc_svs);
            mul_7_itm_1 = conv_u2u_54_27(conv_u2u_3_27(gauss_blur_val_2_sva[29:27])
                * 27'b111000111000111000111001);
            mul_6_itm_1 = conv_u2u_48_24(conv_u2u_3_24(gauss_blur_val_2_sva[26:24])
                * 24'b111000111000111000111);
            mul_5_itm_1 = conv_u2u_42_21(conv_u2u_3_21(gauss_blur_val_2_sva[23:21])
                * 21'b111000111000111001);
            mul_4_itm_1 = conv_u2u_36_18(conv_u2u_3_18(gauss_blur_val_2_sva[20:18])
                * 18'b111000111000111);
            mul_3_itm_1 = conv_u2u_30_15(conv_u2u_3_15(gauss_blur_val_2_sva[17:15])
                * 15'b111000111001);
            mul_2_itm_1 = conv_u2u_24_12(conv_u2u_3_12(gauss_blur_val_2_sva[14:12])
                * 12'b111000111);
            mul_1_itm_1 = conv_u2u_18_9(conv_u2u_3_9(gauss_blur_val_2_sva[11:9])
                * 9'b111001);
            ...
            or_itm_1 = (if_3_acc_svs[3]) | (if_3_acc_svs[2]) | (if_3_acc_svs[1])
                | (if_3_acc_svs[0]);
            or_3_itm_1 = or_3_itm;
            if_4_slc_vga_xy_1_itm_1 = vga_xy[19:10];
            aif_11_slc_svs_st_1 = aif_11_slc_svs_st;
    ...
    main_stage_0_3 = 1'b0;
    main_stage_0_2 = 1'b0;
    aif_11_slc_svs_st_1 = 1'b0;
    if_4_slc_vga_xy_1_itm_1 = 10'b0;
    or_3_itm_1 = 9'b0;
    or_3_itm = 9'b0;
    aif_11_slc_svs_st = 1'b0;
    or_itm_1 = 1'b0;
    mul_itm = 29'b0;
    slc_11_itm_1 = 1'b0;
    slc_13_itm_1 = 5'b0;
    ...
    land_lpi_1_dfm = 1'b0;
    land_sva_1 = 1'b0;
    acc_16_1_sva_dfm = 4'b0;
    if_3_acc_svs = 4'b0;
    if_3_acc_1_psp_sva = 4'b0;
    acc_imod_2_sva = 6'b0;
    acc_2_psp_sva = 29'b0;
    acc_imod_sva = 7'b0;
    gauss_blur_val_2_sva = 32'b0;
    volume_previous_sva = 4'b0;
    blue_xy_1_sva = 10'b0;
    blue_xy_0_sva = 10'b0;
    acc_16_1_sva = 4'b0;
  ...
  function  [28:0] conv_u2u_58_29 ;
    input [57:0]  vector ;
  begin
    conv_u2u_58_29 = vector[28:0];
  end
  endfunction
  ...
  function  [26:0] conv_u2u_54_27 ;
    input [53:0]  vector ;
  begin
    conv_u2u_54_27 = vector[26:0];
  end
  endfunction
  ...
  function  [23:0] conv_u2u_48_24 ;
    input [47:0]  vector ;
  begin
    conv_u2u_48_24 = vector[23:0];
  end
  endfunction
  ...
  function  [20:0] conv_u2u_42_21 ;
    input [41:0]  vector ;
  begin
    conv_u2u_42_21 = vector[20:0];
  end
  endfunction
