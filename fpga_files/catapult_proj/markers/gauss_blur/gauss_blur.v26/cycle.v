...
//  Generated date: Sat May 07 17:02:21 2016
// ----------------------------------------------------------------------
...
module gauss_blur_core (
  ...
  begin : core
    ...
    reg unequal_tmp;
    reg [3:0] acc_14_0_sva_dfm;
    reg [3:0] acc_14_1_sva_dfm;
    reg equal_1_cse_sva;
    reg land_sva_1;
    reg land_lpi_1_dfm;
    ...
    reg land_2_sva_1;
    reg [3:0] acc_14_0_sva_dfm_1;
    reg aif_11_slc_svs;
    reg land_5_sva_1;
    reg land_5_lpi_1_dfm;
    reg aif_17_slc_svs;
    reg aif_17_land_sva_1;
    reg [3:0] acc_14_1_sva_dfm_1;
    reg slc_2_svs;
          ...
          forever begin : main
            ...
            if ( main_stage_0_2 ) begin
              ...
              land_13_lpi_1_dfm = aif_47_land_sva_1 & (~ (deltay_square_blue_acc_psp_sva[10]))
                  & land_14_lpi_1_dfm_1;
              volume_current_sva = conv_s2u_3_4(readslicef_4_3_1((conv_u2s_3_4({volume_current_slc_1_itm_1
                  , 1'b1}) + conv_s2s_3_4({1'b1 , volume_current_slc_acc_idiv_6_itm_1
                  , and_1_itm_1})))) + volume_current_slc_acc_idiv_7_itm_1;
              acc_12_cse_sva = readslicef_6_5_1((({1'b1 , volume_current_sva , 1'b1})
                  + conv_u2s_5_6({(~ volume_previous_sva) , 1'b1})));
              slc_8_svs = readslicef_6_1_5((conv_s2s_5_6(acc_12_cse_sva) + 6'b1));
              if ( slc_8_svs ) begin
              end
              else begin
                land_15_sva_1 = ~ (readslicef_5_1_4((conv_s2u_4_5(~ (acc_12_cse_sva[4:1]))
                    + 5'b1)));
              end
            ...
            unequal_tmp = (if_3_acc_svs[3]) | (if_3_acc_svs[2]) | (if_3_acc_svs[1])
                | (if_3_acc_svs[0]);
            acc_14_0_sva_dfm = acc_14_0_sva & ({{3{unequal_tmp}}, unequal_tmp});
            acc_14_1_sva_dfm = acc_14_1_sva & ({{3{unequal_tmp}}, unequal_tmp});
            ...
            if ( land_2_sva_1 & land_3_lpi_1_dfm ) begin
              acc_14_0_sva_dfm_1 = acc_14_0_sva_dfm + 4'b1;
            end
            else begin
              acc_14_0_sva_dfm_1 = acc_14_0_sva_dfm;
            end
            ...
            if ( aif_17_land_sva_1 & (~ aif_17_slc_svs) & land_5_lpi_1_dfm ) begin
              acc_14_1_sva_dfm_1 = acc_14_1_sva_dfm + 4'b1;
            end
            else begin
              acc_14_1_sva_dfm_1 = acc_14_1_sva_dfm;
            end
            slc_2_svs = readslicef_5_1_4((({1'b1 , (~ acc_14_0_sva_dfm_1)}) + 5'b1001));
            if ( slc_2_svs ) begin
            ...
            red_xy_1_sva_dfm_2 = MUX_v_10_2_2({red_xy_1_sva_dfm , red_xy_1_sva_2},
                and_3_cse);
            slc_3_svs = readslicef_5_1_4((({1'b1 , (~ acc_14_1_sva_dfm_1)}) + 5'b1001));
            if ( slc_3_svs ) begin
            ...
            volume_current_acc_psp_sva = (readslicef_6_5_1((conv_s2s_5_6({(acc_idiv_sva[10:7])
            ...
            acc_14_0_sva = acc_14_0_sva_dfm_1;
            acc_14_1_sva = acc_14_1_sva_dfm_1;
    ...
    slc_2_svs = 1'b0;
    acc_14_1_sva_dfm_1 = 4'b0;
    aif_17_land_sva_1 = 1'b0;
    aif_17_slc_svs = 1'b0;
    land_5_lpi_1_dfm = 1'b0;
    land_5_sva_1 = 1'b0;
    aif_11_slc_svs = 1'b0;
    acc_14_0_sva_dfm_1 = 4'b0;
    land_2_sva_1 = 1'b0;
    ...
    acc_14_1_sva_dfm = 4'b0;
    acc_14_0_sva_dfm = 4'b0;
    unequal_tmp = 1'b0;
    if_3_acc_svs = 4'b0;
