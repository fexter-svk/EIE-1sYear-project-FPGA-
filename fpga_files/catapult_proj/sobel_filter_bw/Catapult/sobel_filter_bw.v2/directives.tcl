...
//  
project new
solution file add {../sobel_filter_source_bw/blur_sob.c} -type C++
solution file add {../sobel_filter_source_bw/blur_sob.h} -type CHEADER
solution file add {../sobel_filter_source_bw/shift_class_sob.h} -type CHEADER
...
directive set -DESIGN_HIERARCHY sobel_filter_bw
go compile
directive set /mean_vga/vga_xy -STREAM 20
directive set /mean_vga/vout -STREAM 30
directive set /mean_vga/core/MAC2 -UNROLL yes
directive set /mean_vga/core/ACC3 -UNROLL yes
...
directive set /sobel_filter_bw/core/MAC2 -UNROLL yes
directive set /sobel_filter_bw/core/ACC3 -UNROLL yes
directive set /sobel_filter_bw/core/ACC1 -UNROLL yes
directive set /sobel_filter_bw/core/SHIFT -UNROLL yes
directive set /sobel_filter_bw/core/main -DISTRIBUTED_PIPELINE true
directive set /sobel_filter_bw/core/main -PIPELINE_INIT_INTERVAL 1
directive set /sobel_filter_bw/vout -STREAM 30
directive set /sobel_filter_bw/vin -STREAM 90
directive set /sobel_filter_bw/vga_xy:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /sobel_filter_bw/vin:rsc -MAP_TO_MODULE {[DirectInput]}
go architect
go extract
