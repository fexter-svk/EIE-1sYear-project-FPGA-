...
//  
//  Running on Windows 7 al3515@EEWS104A-014 Service Pack 1 6.01.7601 i686
//  
...
//  
project new
solution file add {./src2/NewMemory.cpp} -type C++
solution file add {./src2/NewMemory.h} -type CHEADER
...
directive set -DESIGN_HIERARCHY MemBlock
go compile
