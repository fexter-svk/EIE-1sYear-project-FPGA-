...
solution file add {../dot_product_source/dot_product.cpp} -type C++
solution file add {../dot_product_source/dot_product.h} -type CHEADER
solution file add {../dot_product_source/tb_dot_product.cpp} -type C++
