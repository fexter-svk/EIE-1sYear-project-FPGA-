...
void scverify_top::setup_debug()
{
      ...
      debug("input_a:330:input_a",input_a_flags,input_a_count);
      debug("input_b:332:input_b",input_b_flags,input_b_count);
      debug("output:333:output",output_flags,output_count);
}
// ============================================
...
void scverify_top::debug(const char *varname, int flags, int count)
{
   ...
   if (strcmp(varname,"input_a:330:input_a") == 0) {
      xlator_p = input_a_transactor;
   }
   if (strcmp(varname,"input_b:332:input_b") == 0) {
      xlator_p = input_b_transactor;
   }
   if (strcmp(varname,"output:333:output") == 0) {
