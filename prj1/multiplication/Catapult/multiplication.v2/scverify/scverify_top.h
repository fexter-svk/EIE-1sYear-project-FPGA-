...
#define TOP_HDL_ENTITY multiplication
#endif
...
public:
   ...
   sc_signal< sc_lv<40> >                     TLS_input_a_rsc_z;
   sc_signal< sc_lv<40> >                     TLS_input_b_rsc_z;
   sc_signal< sc_lv<40> >                     TLS_output_rsc_z;
   ...
   ccs_DUT_wrapper *multiplication_INST;
   mc_programmable_reset *arst_n_driver;
   mgc_in_wire_trans_rsc< 1,40 > *input_a_rsc_INST;
   mgc_in_wire_trans_rsc< 1,40 > *input_b_rsc_INST;
   mgc_out_stdreg_trans_rsc< 1,40 > *output_rsc_INST;
      ...
      , TLS_fifo_out_output("TLS_fifo_out_output",-1)
   {
      ...
      multiplication_INST = new ccs_DUT_wrapper(
         "rtl",
         TO_QUOTED_STRING(TOP_HDL_ENTITY)
      );
      multiplication_INST->clk(clk);
      multiplication_INST->en(TLS_en);
      multiplication_INST->arst_n(TLS_arst_n);
      multiplication_INST->input_a_rsc_z(TLS_input_a_rsc_z);
      multiplication_INST->input_b_rsc_z(TLS_input_b_rsc_z);
      multiplication_INST->output_rsc_z(TLS_output_rsc_z);
      ...
      input_a_rsc_INST = new mgc_in_wire_trans_rsc< 1,40 > (
         "input_a_rsc",
         true
      );
      ...
      input_b_rsc_INST = new mgc_in_wire_trans_rsc< 1,40 > (
         "input_b_rsc",
         true
      );
      ...
      output_rsc_INST = new mgc_out_stdreg_trans_rsc< 1,40 > (
         "output_rsc",
         true
      );
      ...
      input_a_transactor->register_block(input_a_rsc_INST,input_a_rsc_INST->basename(),in_sync,0,0,1);
      ...
      input_b_transactor->register_block(input_b_rsc_INST,input_b_rsc_INST->basename(),in_sync,0,0,1);
   ...
   ~scverify_top()
   {
      delete multiplication_INST;
      multiplication_INST = 0;
