...
solution file add {../multiplication_source/multiplication.cpp} -type C++
solution file add {../multiplication_source/tb_multiplication.cpp} -type C++
solution file add {../multiplication_source/multiplication.h} -type CHEADER
