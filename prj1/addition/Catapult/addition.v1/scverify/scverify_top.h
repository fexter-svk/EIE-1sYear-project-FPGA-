...
#define TOP_HDL_ENTITY addition
#endif
...
public:
      ...
      , TLS_fifo_out_output("TLS_fifo_out_output",-1)
   {
      ...
      addition_INST = new ccs_DUT_wrapper(
         "rtl",
         TO_QUOTED_STRING(TOP_HDL_ENTITY)
      );
      addition_INST->clk(clk);
      addition_INST->en(TLS_en);
      addition_INST->arst_n(TLS_arst_n);
      addition_INST->input_a_rsc_z(TLS_input_a_rsc_z);
      addition_INST->input_b_rsc_z(TLS_input_b_rsc_z);
      addition_INST->output_rsc_z(TLS_output_rsc_z);
