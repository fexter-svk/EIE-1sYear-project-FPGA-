...
extern "C++" void addition( ac_int<8, true > *input_a,  ac_int<8, true > *input_b,  ac_int<8, true > *output);
...
// ============================================
// Function: exec_addition
// --------------------------------------------

void testbench::exec_addition( ac_int<8, true > *input_a,  ac_int<8, true > *input_b,  ac_int<8, true > *output)
{
   that->cpp_testbench_active.write(true);
   capture_IN(input_a, input_b, output);
   addition(input_a, input_b, output);
