...
solution file add {../addition_source/addition.cpp} -type C++
solution file add {../addition_source/addition.h} -type CHEADER
solution file add {../addition_source/tb_addition.cpp} -type C++
...
directive set -DESIGN_HIERARCHY addition
go compile
directive set /addition/core/main -DISTRIBUTED_PIPELINE true
directive set /addition/core/main -PIPELINE_INIT_INTERVAL 1
directive set /addition/input_b -STREAM 8
directive set /addition/input_b -WORD_WIDTH 8
directive set /addition/input_a -STREAM 8
directive set /addition/input_a -WORD_WIDTH 8
go architect
go extract
