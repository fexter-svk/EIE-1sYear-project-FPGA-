...
//  
project new
solution file add {../sobel_filter_source/tb_blur_sob.cpp} -type C++
solution file add {../sobel_filter_source/blur_sob.c} -type C++
solution file add {../sobel_filter_source/blur_sob.h} -type CHEADER
solution file add {../sobel_filter_source/bmp_io_sob.h} -type CHEADER
solution file add {../sobel_filter_source/bmp_io_sob.cpp} -type C++
solution file add {../sobel_filter_source/shift_class_sob.h} -type CHEADER
...
directive set /mean_vga/core/FRAME -UNROLL yes
directive set /mean_vga/core/sqrt:for -UNROLL yes
go architect
